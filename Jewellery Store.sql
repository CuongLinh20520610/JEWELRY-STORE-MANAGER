...
CREATE PROCEDURE ThemTaiKhoan (
    ...
    IN p_TenTaiKhoan NVARCHAR(50),
    IN p_MatKhau VARCHAR(100),
    IN p_HoTen VARCHAR(50),
    IN p_LoaiNguoiDung VARCHAR(50)
)
BEGIN
    INSERT INTO TaiKhoan (MaNguoiDung, TenTaiKhoan, MatKhau, HoTen, LoaiNguoiDung)
    VALUES (p_MaNguoiDung, p_TenTaiKhoan, p_MatKhau, p_HoTen, p_LoaiNguoiDung);
END;
DELIMITER ;
